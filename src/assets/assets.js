...
const CertificatesPage = [
  ...
  },
  {
    ...
    issuedBy: "UDEMY",
    credentialURL:
      "https://www.udemy.com/certificate/UC-4fba38e0-1953-4a0d-8931-105f75d8bdcc/",
  },
  {
    ...
    issuedBy: "UDEMY",
    credentialURL:
      "https://www.udemy.com/certificate/UC-d150c485-8c8e-4a04-8999-feff3b989ca6/",
  },
];
...
const projectsPage = [
  ...
  },
  {
    ...
    projectDescription:
      "Compro with CRUD Capabilities for regular IDX checking",
    projectDetails: "Pelayaran Nelly Dwi Putri Tbk.",
  ...
  },
  {
    ...
    projectDescription:
      "ERP, SFA, UI Library, HRIS, Geo-Mapping App, Geo-Tagging App, etc",
    projectDetails:
      "Not all Screenshot provided, since some contains confidential information",
    projectRole:
      "Sr. Frontend Developer -> Technical Lead Frontend & Full-Stack Developer",
    projectURL: "",
    screenshots: [
      ErpScreenshot,
      SfaScreenshot,
      RestaurantScreenshot,
      SurveyorScreenshot,
    ],
